...
class Database {
     ...
     * @return object $instance
     */
    public static function where($collumn, $operator, $value, $type = null) {
        $where = '`' . $collumn . '`' . $operator . ' ? ';
        if (! static::$where) {
     ...
     * @return object $instance
     */
    public static function orWhere($collumn, $operator, $value) {
        static::where($collumn, $operator, $value, "OR");
     ...
     * @return object $instance
     */
    public static function having($collumn, $operator, $value) {
        $having = '`' . $collumn . '`' . $operator . ' ? ';
        if (! static::$having) {
        ...
        static::$having[] = htmlspecialchars($value);
        return static::instance();
    }
